...
h3.break>a {
 ...
 <div class="navbar-wrapper">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <a class="left carousel-control" href="${APP_PATH }/#myCarousel" role="button" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left"></span>
        <span class="sr-only">Previous</span>
      </a>
      <a class="right carousel-control" href="${APP_PATH }/#myCarousel" role="button" data-slide="next">
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <p><a class="btn btn-default" href="${APP_PATH }/project.html" role="button">项目详情 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			<div class="box ui-draggable" id="mainBox">
				<div class="mHd" style="">
					<div class="path">
						<a href="${APP_PATH }/projects.html">更多...</a>
					</div>
					<h3>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3 class="break">
								<a href="${APP_PATH }/project.html">活性富氢净水直饮机</a>
							</h3>
                            <p>
				...
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3 class="break">
								<a href="${APP_PATH }/project.html">酷驰触控龙头，智享厨房黑科技</a>
							</h3>
                            <p>
                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
				...
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3 class="break">
								<a href="${APP_PATH }/project.html">小熊猫鱼眼全景安防摄像机</a>
							</h3>
                            <p>
                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
				...
				<div class="col-md-3">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3 class="break">
								<a href="${APP_PATH }/project.html">一款精致的机械表</a>
							</h3>
                            <p>
                                <div style="float:left;"><i class="glyphicon glyphicon-screenshot" title="目标金额" ></i> $20,000 </div>
                                <div style="float:right;"><i title="截至日期" class="glyphicon glyphicon-calendar"></i> 2017-20-20 </div>
...
<div class="container">
	<div class="row clearfix">
		<div class="col-md-12 column">
			<div id="footer">
				<div class="footerNav">
					 <a rel="nofollow" href="http://www.gwz.com">关于我们</a> | <a rel="nofollow" href="http://www.gwz.com">服务条款</a> | <a rel="nofollow" href="http://www.gwz.com">免责声明</a> | <a rel="nofollow" href="http://www.gwz.com">网站地图</a> | <a rel="nofollow" href="http://www.gwz.com">联系我们</a>
				</div>
				<div class="copyRight">
					Copyright ?2017-2017gwz.com 版权所有
				</div>
			</div>
