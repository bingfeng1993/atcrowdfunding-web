			  ...
			  <div class="panel-body">
				<form id="roleForm" role="form">
				  <div class="form-group">
					<label for="exampleInputPassword1">职位名称</label>
					<input type="text" class="form-control" id="role" value="${role.role }" placeholder="请输入职位名称">
				  </div>
        ...
        <script type="text/javascript">
            $(function () {
			    ...
			    $("#updateBtn").click(function(){
			    	var loginacct = $("#role");
			    	if(loginacct.val() == ""){
			    		layer.msg("职位名称不能为空，请重新输入", {time:3000, icon:5, shift:6}, function(){
			        		loginacct.focus();
			        	});
			    		return;
			    	}
			    	...
			    	$.ajax({
			    		...
			    		success : function(result){
			    			...
			    			if(result.success){
			    				layer.msg("职位信息修改成功", {time:2000, icon:6}, function(){
				    				window.location.href = "${APP_PATH}/role/index?pageno=${param.pageno}";
			                   	});
			    			}else{
			    				layer.msg("职位信息修改失败，请重新操作", {time:2000, icon:5, shift:6}, function(){
			                   	});
			    			}
			    		}
			    	});
