	...
	<script src="${APP_PATH }/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            function pageQuery(pageIndex){
            	...
            	var dataObj = {pageno : pageno,pagesize : 3};
            	if(condflg = true){
            			...
            			if(result.success){
            				...
            				$.each(roles , function(index , role){
            					content += '<tr>';
             					...
             					content += '	  <button type="button" onclick="deleteRole('+role.id+',\''+role.role+'\')" class="btn btn-danger btn-xs"><i class=" glyphicon glyphicon-remove"></i></button>';
             					content += '  </td>';
             	                content += '</tr>';
            				});
            ...
            function deleteRole(id,role){
            	layer.confirm("删除职位信息【"+role+"】，是否继续？",  {icon: 3, title:'提示'}, function(cindex){
            		...
            		$.ajax({
            			...
            			success : function(result){
            				if(result.success){
            					...
            					layer.msg("职位信息删除失败", {time:2000, icon:5, shift:6}, function(){
                            	});
            				}
            			}
            		});
            ...
            function selAllBox(box){
            	...
            	var flg = box.checked;
				//获取所有的用户的复选框
				var userBoxes = $("#roleTbody :checkbox");
            ...
            function deleteRoles(){
            	...
            	if(roleCheckedBoxes.length == 0){
            		layer.msg("请选择需要删除的职位信息", {time:2000, icon:5, shift:6}, function(){
                	});
            	}else{
            		layer.confirm("删除选择的职位信息，是否继续？",  {icon: 3, title:'提示'}, function(cindex){
        			    
            			var jsonData = {};
            			$.each(roleCheckedBoxes , function(i,n){
