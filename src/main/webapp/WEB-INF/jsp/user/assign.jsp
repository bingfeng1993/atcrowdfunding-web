        ...
        <script type="text/javascript">
            $(function () {
	            	...
	            	$.ajax({
	            		...
	            		success : function(result){
	            			if(result.success){
	            				...
	            				layer.msg("分配角色信息失败", {time:2000, icon:5, shift:6});
	            			}
	            		}
	            	});
	            });
	            $("#right2LeftBtn").click(function(){
	            	...
	            	if(selOptions.length == 0){
	            		layer.msg("请选择取消分配的角色数据", {time:2000, icon:5, shift:6});
	            		return;
	            	}
	            	//将选中的元素移动到左边列表
	            	var jsonData = {"userid":"${user.id}"}
	            	...
	            	$.ajax({
	            		...
	            		success : function(result){
	            			if(result.success){
	            				...
	            				layer.msg("取消分配角色信息失败", {time:2000, icon:5, shift:6});
	            			}
	            		}
	            	});
	            });
